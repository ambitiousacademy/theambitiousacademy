export default function FAQ(){
    return (
        <>
        <section className="mb-24 bg-white tails-selected-element">
    <div className="px-8 mx-auto max-w-7xl lg:px-16">
        ...
        <div className="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
            ...
            <div className="">
                ...
                <p className="">Implementation in your project is very simple. You can use the exported page as a starting point, or you can copy and paste the HTML into your own page.</p>
                <h5 className="mt-10 mb-3 font-semibold text-gray-900">What is the license on the pages?</h5>
                <p className="">You have unlimited use to the templates used in Tails; however, you cannot re-use the templates to sell for others to use.</p>
                <h5 className="mt-10 mb-3 font-semibold text-gray-900">Can I cancel my account if I not longer need it?</h5>
                <p className="">Of course, you can feel free to cancel your account at anytime, and you can feel free to come back and upgrade again whenever you&apos;re ready.</p>
