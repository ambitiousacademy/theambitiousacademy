  ...
  return (
    <div><section className="py-8">
      ...
      <div className="max-w-2xl mb-10">
                    <h2 className="text-2xl font-bold md:text-4xl md:leading-tight">Hi!. There.</h2>
          ...
          {courseData.map((data, index) => (
            <div key={index} className={`w-full text-${data.textColor} lg:w-1/3 p-4`}>
              <div className={`border border-gray-200 p-12 rounded-3xl h-full bg-${data.color}`}>
                ...
                <a href={`${data.link}`} className="bg-black h-14 w-full rounded-full px-5 py-3 inline-flex items-center justify-center gap-2 tracking-tight hover:bg-orange-600 focus:bg-orange-500 focus:ring-4 focus:ring-orange-200 transition duration-200">
