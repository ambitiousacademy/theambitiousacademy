      ...
      <div className="services-container">
        <div className="services-inner-container">
          <div className="services-header">
            ...
            {/* <p className="services-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime delectus deserunt fuga fugiat excepturi voluptas ad quam magni eius sit.</p> */}
          </div>
          ...
          <div className="services-grid">
            ...
            <div className="service-image service-image-visible">
              <img className="rounded-xl" src="\photos\services.png" alt="Image Description" />
            </div> 
          </div>
        </div>
      </div>
